app.service('AuthenticationService',['$http', '$cookies', '$rootScope', 'usuarioService',function($http, $cookies, $rootScope, usuarioService)
{
        this.Login = function(username, password, callback) {
            usuarioService.dbGetUsuariosPorNombre(username)
                .then(function (user) {
        ...
        // setea la variable que será cargada en la cookie
